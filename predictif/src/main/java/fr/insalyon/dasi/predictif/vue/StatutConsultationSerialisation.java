 ...
 * @author etarassov
 */
public class StatutConsultationSerialisation extends Serialisation {
    ...
    public void serializer(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Boolean consultationAcceptee = (Boolean)request.getAttribute("consultationAcceptee");
        JsonObject jsonConnexion = new JsonObject();

        jsonConnexion.addProperty("consultationAcceptee", consultationAcceptee);
